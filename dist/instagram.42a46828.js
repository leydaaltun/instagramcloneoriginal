...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"instagram.js":[function(require,module,exports) {
var username = 'Leyda';
var likeCount = 0;
var likeCountElem = document.querySelector('.likes-edit'); //console.log(likeCountElem)

var likeButton = document.querySelector('.like-img'); //console.log(likeButton)

likeButton.addEventListener('click', addLikeCount);

function addLikeCount() {
  if (likeButton.classList.contains('liked') === false) {
    likeCountElem.innerHTML = " 1 Like"; // likeCount = likeCount + 1

    likeCount = "".concat(likeCount, " 1 ");
...
var commentInput = document.querySelector('.input');
var commentsContainer = document.querySelector('.add-comment'); //console.log(commentsContainer)
...
function addComment(commentText) {} // function addComment(commentText) {
//     const commentHTML = 
// }
...
},{}]},{},["../../Users/leyda/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","instagram.js"], null)
//# sourceMappingURL=/instagram.42a46828.js.map